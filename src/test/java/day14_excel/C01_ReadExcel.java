...
public class C01_ReadExcel {
    ...
    public void readExcelTest() throws IOException {
      //1-Dosya yolu'nu bir String degiskene atayalım
      ...
      //7-Cell objesi olusturun row.getCell(index)
        ...
        //3.index'deki  satırın 3.index'indeki datanın Cezayir oldugunu test edin

         String expectedData="Cezayir";
         String actualData=cell.toString();

        Assert.assertEquals(expectedData,actualData);
        //Assert.assertEquals(expectedData,cell.getStringCellValue()); bu da olur
